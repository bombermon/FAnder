class Validator:
    ...
    def checkPartner(self, user, partner):
        ...
        if (partner['age'] >= user['p_min_age']) and (partner['age'] <= user['p_max_age']) and (partner['sex'] == user['p_sex']) and (pCity == uCity) and ((partner['dialog_status'] == "process") or (partner['dialog_status'] == "freezed")):
